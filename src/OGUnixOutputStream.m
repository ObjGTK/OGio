...
- (bool)closeFd
{
	bool returnValue = (bool)g_unix_output_stream_get_close_fd((GUnixOutputStream*)[self castedGObject]);
...
- (gint)fd
{
	gint returnValue = (gint)g_unix_output_stream_get_fd((GUnixOutputStream*)[self castedGObject]);
...
{
	g_unix_output_stream_set_close_fd((GUnixOutputStream*)[self castedGObject], closeFd);
}
