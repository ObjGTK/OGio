...
+ (GTypeClass*)gObjectClass
{
	...
	gObjectClass = g_type_class_ref(G_TYPE_CREDENTIALS);
	return gObjectClass;
}

+ (instancetype)credentials
{
	GCredentials* gobjectValue = G_TYPE_CHECK_INSTANCE_CAST(g_credentials_new(), G_TYPE_CREDENTIALS, GCredentials);
...
{
	return G_TYPE_CHECK_INSTANCE_CAST([self gObject], G_TYPE_CREDENTIALS, GCredentials);
}
